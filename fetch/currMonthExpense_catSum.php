...
$iduser = $_SESSION['zalogowany']->id;
    ...
    mysqli_report(MYSQLI_REPORT_STRICT);//sposob raportowania bledow
        ...
        try
        {
            ...
            {  
                $zapytanie = "SELECT ROUND(SUM(kwota),2) AS 'Suma', kategoria FROM wydatki WHERE iduzytkownika ='$iduser' AND YEAR(data) = YEAR(CURRENT_DATE) AND MONTH(data) = MONTH(CURRENT_DATE) GROUP BY kategoria";
