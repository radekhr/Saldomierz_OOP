...
$iduser = $_SESSION['zalogowany']->id;
    ...
    mysqli_report(MYSQLI_REPORT_STRICT);//sposob raportowania bledow
        ...
        try
        {
            ...
            {  
                $zapytanie = "SELECT * FROM wydatki WHERE iduzytkownika='$iduser' AND YEAR(data) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH) AND MONTH(data) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH) ORDER BY data DESC";
